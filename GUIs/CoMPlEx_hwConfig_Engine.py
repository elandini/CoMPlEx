...
class hwConfig_dial(Ui_hwConfig_dialog,QDialog):
    ...
    def fillControls(self):
        ...
        self.movingObjCmbBox.setCurrentIndex(int(self.parser.get('PIEZO','movobj')))
        ...
        self.maxDeflVoltNumDbl.setValue(float(self.parser.get('OTHER','deflmax')))
        self.minDeflVoltNumDbl.setValue(float(self.parser.get('OTHER','deflmin')))
