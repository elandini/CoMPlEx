...
class Ui_hwConfig_dialog(object):
    def setupUi(self, hwConfig_dialog):
        ...
        self.formLayout_2.setWidget(6, QtGui.QFormLayout.FieldRole, self.toStartSpeedNumDbl)
        ...
        self.formLayout_2.setWidget(5, QtGui.QFormLayout.FieldRole, self.maxSpeedNumDbl)
